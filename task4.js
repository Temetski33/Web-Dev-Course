...
function evaluateScore() {
  ...
  if (score >= 0 && score <= 39) {
    outputElement.innerText += "Your grade is 0";
  } else if (score >= 40 && score <= 51) {
    outputElement.innerText += "Your grade is 1";
  } else if (score >= 52 && score <= 63) {
    outputElement.innerText += "Your grade is 2";
  } else if (score >= 64 && score <= 75) {
    outputElement.innerText += "Your grade is 3";
  } else if (score >= 76 && score <= 87) {
    outputElement.innerText += "Your grade is 4";
  } else if (score >= 88 && score <= 99) {
    outputElement.innerText += "Your grade is 5";
  } else {
